...
from solvers.rigidity_solver.algo_core import solve_rigidity_new
...
if __name__ == "__main__":
    ...
    trivial_motions, non_trivial_motions, non_zero_eigenspace = solve_rigidity_new(points, edges, joints, fixed_points_idx=fixed_points_index, dim=2)
